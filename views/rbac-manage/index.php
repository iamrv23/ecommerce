...
<div class="rbac-manage-index">
    ...
    <p>
        <?= Html::a('View Audit Log', ['audit'], ['class' => 'btn btn-outline-secondary']) ?>
    </p>
                ...
                <?php foreach ($roles as $r): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?= Html::a('Delete', ['delete-role', 'name' => $r->name], ['class' => 'btn btn-sm btn-danger', 'data' => ['confirm' => 'Delete this role?']]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
